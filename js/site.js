...
(function(){
  try {
    ...
    function cardHtml(p){
      ...
      var installHtml = 'Até 12x de ' + esc(brl(price / 12));
...
(function(){
  ...
  const infoContent = {
    ...
    privacidade: { title: 'Política de privacidade', body: '<p>Seus dados pessoais são utilizados exclusivamente para processar pedidos, comunicação sobre compras e melhorias na experiência de compra.</p><p>Não compartilhamos suas informações com terceiros para fins de marketing sem o seu consentimento.</p>' },
    termos: { title: 'Termos de serviço', body: '<p>Ao utilizar este site, você concorda com nossas condições de compra, incluindo preços, formas de pagamento e prazos de entrega apresentados no momento da finalização do pedido.</p><p>Reservamo-nos o direito de atualizar estes termos periodicamente.</p>' },
    devolucoes: { title: 'Devoluções e reembolso', body: '<p>Você pode solicitar troca ou devolução em até 7 dias corridos após o recebimento do produto, desde que ele esteja sem uso e com a etiqueta original.</p><p>O reembolso é processado após o recebimento e conferência do produto devolvido.</p>' },
